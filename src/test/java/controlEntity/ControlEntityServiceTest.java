...
public class ControlEntityServiceTest extends AbstractTest {
	...
	public void driverCreateControlEntity() {
		...
		Object testingData[][] = {
				...
				{
						// POSITIVE CASE
						"company1", super.getEntityId("problem1"), "body", true, null },

				{
						// NEGATIVE CASE
						"company2", super.getEntityId("problem1"), "body", true, IllegalArgumentException.class } };
	...
	private void createControlEntityTemplate(String company, Integer problemId, String body, Boolean isDraftMode, Class<?> expected) {
