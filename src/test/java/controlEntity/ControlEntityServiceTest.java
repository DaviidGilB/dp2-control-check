...
public class ControlEntityServiceTest extends AbstractTest {
	...
	public void driverCreateControlEntity() {
		...
		Object testingData[][] = {
				...
				{
						// POSITIVE CASE
						"company1", super.getEntityId("application2"), "body", true, null },

				{
						// NEGATIVE CASE
						"company2", super.getEntityId("application2"), "body", true, IllegalArgumentException.class } };
	...
	private void createControlEntityTemplate(String company, Integer applicationId, String body, Boolean isDraftMode, Class<?> expected) {
