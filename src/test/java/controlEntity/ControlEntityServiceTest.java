...
public class ControlEntityServiceTest extends AbstractTest {
	...
	public void driverCreateControlEntity() {
		...
		Object testingData[][] = {
				...
				{
						// POSITIVE CASE
						"company1", super.getEntityId("position1"), "body", true, null },

				{
						// NEGATIVE CASE
						"company2", super.getEntityId("position1"), "body", true, IllegalArgumentException.class } };
	...
	private void createControlEntityTemplate(String company, Integer positionId, String body, Boolean isDraftMode, Class<?> expected) {
