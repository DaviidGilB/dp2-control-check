...
public class ControlEntityServiceTest extends AbstractTest {
	...
	public void driverCreateControlEntity() {
		...
		Object testingData[][] = {
				...
				{
						// POSITIVE CASE
						"auditor1", super.getEntityId("audit1"), "body", true, null },

				{
						// NEGATIVE CASE
						"auditor2", super.getEntityId("audit1"), "body", true, IllegalArgumentException.class } };
	...
	private void createControlEntityTemplate(String auditor, Integer auditId, String body, Boolean isDraftMode, Class<?> expected) {
